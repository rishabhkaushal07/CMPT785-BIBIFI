...
int user_features(string user_type) {
    ...
    if (cmd == "cd") {
        ...
        /*
         * Share the file with the target user which should appear under the `/shared` directory of the target user.
         * The files are shared only with read permission.
         * The shared directory must be read-only.
         * If the file doesn't exist, print "File <filename> doesn't exist".
         * If the user doesn't exist, print "User <username> doesn't exist".
         * First check will be on the file.
         *
         */
         ...
         * If the file was previously shared, the target user should see the new contents of the file.
         */
         ...
         * If a user with this name already exists, print "User <username> already exists"
         */
